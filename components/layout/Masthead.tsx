...
export function Masthead() {
  ...
  const handleSearchToggle = () => {
    ...
    window.dispatchEvent(
      new CustomEvent("searchStateChange", {
  ...
  return (
    <>
      <header
        className="masthead relative z-2 bg-background text-center overflow-hidden w-full flex-shrink-0 px-[30px]"
        ...
        <div className="masthead__wrapper">
          ...
          <div>
            <Link href="/" className="no-underline">
              ...
              <h1
                className="masthead-title flex items-center justify-center flex-wrap font-brand font-[900] my-[30px_0_20px_0]"
                style={{
          ...
          {/* Masthead Bar */}
          <div
            className="masthead-bar relative h-[40px] overflow-hidden border-t-2 border-b-2 border-foreground text-center uppercase text-[14px] tracking-[1px]"
          ...
          >
            ...
            >
              <div className="flex items-center justify-center h-full relative">
                <span className="masthead-bar__intro hidden md:inline">
                  A recreation of{" "}
                </span>
                ...
                <button
                  ...
                  className="masthead-bar__open-search-button search-button absolute top-0 right-0 h-full px-6 cursor-pointer group"
                  aria-label="Open search"
                >
                  <Search className="search-button__icon w-6 h-6 inline align-middle transition-transform duration-100 group-hover:scale-110" />
                </button>
              </div>
            </div>
